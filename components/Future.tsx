    ...
    <section className="text-primary py-20 backdrop-blur">
      <div className="container mx-auto flex flex-col md:flex-row">
        <div className="md:w-1/4 pr-8 mb-12 md:mb-0">
          <h2 className="text-5xl font-extrabold sticky top-20 text-primary/80">🚀CURRENTLY</h2>
        </div>
        <div className="md:w-3/4">
          {futureProjects.map((project) => (
            <div
            key={project.id}
            className={`flex items-start ${project.id === futureProjects.length ? "mb-16" : "mb-60"}`}
          >
              ...
              <div>
                <h3 className="text-6xl font-bold mb-2 text-purple-500">{project.title}</h3>
